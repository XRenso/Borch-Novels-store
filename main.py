...
async def tg_post(message: types.Message):
    if db.return_user_info(message.from_user.id)['is_admin']:
        ...
        await bot.send_photo(chat_id=1947730203,photo='AgACAgIAAxkBAAIZlGSSdZ8ekz_L3D1UdfCD_2cKPV97AAJNxzEbVxOYSDqKrtfuwW3mAQADAgADeQADLwQ', caption=phrase.post_text,reply_markup=markup)
