...
async def send_game_info_inline(inline_query:types.InlineQuery):
    ...
    if games != 0:
        results = []
        for i in games:
            markup = InlineKeyboardMarkup().add(InlineKeyboardButton('Перейти к боту', url=f'https://t.me/BorchStoreBot?start={i["game_code"]}'))
            ...
            item = InlineQueryResultCachedPhoto(
                ...
                caption=caption,
                reply_markup=markup # {"id": "2074719242475204628", "from": {"id": 483058216, "is_bot": false, "first_name": "Товарищ", "last_name": "Рабочий", "username": "XRenso", "language_code": "ru"}, "inline_message_id": "AgAAAC93AgAo4socCpCtTODotO8", "chat_instance": "2634033057511433901", "data": "game:guide_store"}
            )
            results.append(item)
